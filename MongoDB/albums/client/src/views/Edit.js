...
const Edit = (props) => {
    ...
    return(
        ...
        <form onSubmit={onSubmitHandler}>
            ...
            <div className="form-group">
                <input name="imgURL" value={form.imgURL} className="form-control" type="text" placeholder="imgURL" onChange={onChangeHandler} />
                <span className="alert-danger">{errors.imgURL && errors.imgURL.message}</span>

            </div>

            <div className="form-group">
                <input name="releaseYear" value={form.releaseYear} className="form-control" type="number" placeholder="releaseYear name" onChange={onChangeHandler} />
            ...
            <div className="form-group">
                <input name="rating" value={form.rating} className="form-control" type="number" placeholder="rating" onChange={onChangeHandler} />
