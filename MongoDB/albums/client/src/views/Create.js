    ...
    return (
        <div className="w-50 mx-auto p-3">
            <form onSubmit={onSubmitHandler}>
                ...
                <div className="form-group">
                    <input name="imgURL" className="form-control" type="text" placeholder="imgURL" onChange={onChangeHandler} />
                </div>

                <div className="form-group">
                    <input name="releaseYear" className="form-control" type="number" placeholder="releaseYear name" onChange={onChangeHandler} />
                </div>
                ...
                <div className="form-group">
                    <input name="rating" className="form-control" type="number" placeholder="rating" onChange={onChangeHandler} />
                </div>
